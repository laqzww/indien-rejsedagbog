  ...
  return (
    <>
      ...
      <div className="relative rounded-xl overflow-hidden bg-muted group/gallery">
        <div className="overflow-hidden" style={{ touchAction: 'manipulation' }} ref={emblaRef}>
          <div className="flex">
            {media.map((item) => (
              <div 
                key={item.id} 
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-[60] bg-black flex items-center justify-center animate-fade-in">
          <div className="absolute inset-0 flex items-center justify-center w-full h-full overflow-hidden" style={{ touchAction: 'manipulation' }} ref={fullscreenEmblaRef}>
