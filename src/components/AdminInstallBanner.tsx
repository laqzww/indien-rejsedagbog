...
import { X, Share, Plus, Download, Shield, MoreVertical, Menu, EllipsisVertical } from "lucide-react";
import { cn } from "@/lib/utils";

// LocalStorage key for dismiss state (separate from public app)
...
export function AdminInstallBanner() {
  ...
  const getBannerMessage = () => {
    if (platform === "ios" && browser !== "safari") {
      return "Åbn i Safari for admin-app";
    }
    return "Installer admin-app";
  };

  return (
    <>
      {/* Main Banner - Admin themed */}
      <div
        className={cn(
          "w-full bg-gradient-to-r from-navy/10 to-saffron/10",
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-2.5 gap-3">
            ...
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-navy/20 flex items-center justify-center">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {hasNativeInstall && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-navy text-white text-sm font-medium rounded-lg hover:bg-navy-light transition-colors"
                >
...
// =============================================================================
// Admin Install Guide Modal Component
// =============================================================================

interface AdminInstallGuideModalProps {
  platform: Platform;
  browser: Browser;
  onClose: () => void;
  onDismiss: () => void;
...
// Get browser-specific instructions (same logic as InstallBanner)
...
function AdminInstallGuideModal({ platform, browser, onClose, onDismiss }: AdminInstallGuideModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center animate-fade-in">
      ...
      <div className="relative w-full sm:max-w-sm mx-4 mb-4 sm:mb-0 bg-white rounded-2xl shadow-xl animate-slide-up overflow-hidden">
        {/* Header - Admin themed */}
        <div className="flex items-center justify-between p-4 border-b border-border bg-gradient-to-r from-navy/5 to-transparent">
          <div>
        ...
        <div className="p-4 pt-0 flex gap-2">
          <button
            onClick={onClose}
            className="flex-1 py-2.5 px-4 bg-navy text-white font-medium rounded-lg hover:bg-navy-light transition-colors"
          >
            Forstået
          </button>
          <button
